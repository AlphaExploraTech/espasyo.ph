...
const Resources = () => {
  ...
  return (
    ...
    >
      {/* --- GRAIN TEXTURE (Optimized for performance: removed mix-blend-overlay and svg filter, using simple opacity background if needed, but omitted here to prevent lag) --- */}
      <div className="fixed inset-0 pointer-events-none opacity-[0.02] z-[1] bg-[url('/noise.png')] bg-repeat" />
